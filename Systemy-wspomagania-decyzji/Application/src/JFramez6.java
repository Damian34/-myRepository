 ...
 * @author dami
 */
public class JFramez6 extends javax.swing.JFrame {

    public List<String> list=new ArrayList<>();
    
    JFramez3 frame;
    /**
     * Creates new form JFramezz12
     */
    public JFramez6() {
        try {
    ...
    public JFramez6(List<String> list ,JFramez3 fr) {
        initComponents();
    ...
    public void pisz()
    {
        ...
        {
            if(i!=list.size()-1)
            zapis.println(list.get(i));
            else
            zapis.print(list.get(i));
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFramez6.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
