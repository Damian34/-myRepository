...
public class ProductFrame extends javax.swing.JFrame {
    ...
    public Attribute getAttribute() {
        ...
        //System.out.println(nr+" | "+price+" | "+reduction);
        //System.out.println("reduction: "+reduction+" | "+reduction.length());
        ...
        /*for(int i=0;i<list.size();i++){
            System.out.println(list.get(i)[0]+" | "+list.get(i)[3]);
        }*/
        ...
        //System.out.println("reduction1: "+r.reduction);
    ...
    /*public String convertStringToNumber(String s) {
        try {
            Double.valueOf(s);
