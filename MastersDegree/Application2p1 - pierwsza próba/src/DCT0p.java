...
public class DCT0p {
    ...
    public BufferedImage WriteToImage(BufferedImage im,BufferedImage im2)
    {
    ...
    public static void main(String args[]) {
        ...
        try{
            ...
            //szerokosc / wysokosc
            /*Image scaledImage =  c.ic.deepCopy(image0).getScaledInstance(768,1024,Image.SCALE_SMOOTH);
            BufferedImage image = c.ic.toBufferedImage(scaledImage);   */       
            BufferedImage image = c.ic.resizeImage(c.ic.deepCopy(image0), 768,1024);
            
            int size=8;
            //Image scaledImage2 =  c.ic.deepCopy(image0).getScaledInstance(size,size,Image.SCALE_SMOOTH);
            /*Image scaledImage2 =  c.ic.deepCopy(image0).getScaledInstance(size,size,Image.SCALE_SMOOTH);
            BufferedImage image2 = c.ic.ImageToBlackAndWhite(c.ic.toBufferedImage(scaledImage2));*/
            
            
            
            BufferedImage image3 = c.WriteToImage(image,imagePom); 
            ...
            ImageIO.write(image6, "BMP", new File("2.odczytany-obraz-"+st+" .bmp"));
            }
